...
heatmap_min <- ifelse(is.null(heatmap_fixed_min), NULL, heatmap_fixed_min)
heatmap_max <- ifelse(is.null(heatmap_fixed_max), NULL, heatmap_fixed_max)
...
}else{	d1$pam = substr(d1$Site_SubstitutionsOnly.Sequence, 1, lenTarget - lenSpacer)} # 5' PAM
